...
`design/` holds lasting internal guidance, accepted decisions and the rationale behind them. Pages distinguish implemented behavior from the intended API and retain useful alternatives. Public rendered documentation lives in `docs/`; its narrative prose remains human-authored.
